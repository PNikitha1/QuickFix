...
// Define ProviderProfile in the same file
const ProviderProfile = ({ params }: { params: { providerId: string } }) => {
  ...
  const provider = serviceProviders.find((p) => p.id === parseInt(providerId, 10));
  ...
  return (
    <div className={styles.providerProfileContainer}>
      ...
      <form onSubmit={handleBookingSubmit} className={styles.bookingForm}>
        ...
        <label className={styles.label}>
          Address:
          <input className={styles.input} type="text" placeholder="Enter your address" required />
        </label>

        <label className={styles.label}>
          Phone Number:
          <input className={styles.input} type="text" placeholder="Enter your PhoneNumber" required />
        </label>
